    ...
    <div class="col-md-3">
      ...
      <div class="box box-primary">
        <div class="box-body box-profile">
          ...
          <a href="#" class="btn bg-purple btn-block"><b>Upload Foto</b></a>
          <a href="/pegawai/beranda" class="btn btn-danger btn-block"><b>Kembali</b></a>
        </div>
        <!-- /.box-body -->
      </div>
      <!-- /.box -->
    ...
    <div class="col-md-9">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li class="{{$active == 'profile' ? 'active':''}}"><a href="#profile" data-toggle="tab">Profile Diri</a></li>
          <li class="{{$active == 'kependudukan' ? 'active':''}}"><a href="#kependudukan" data-toggle="tab">Kependudukan</a></li>
          <li class="{{$active == 'bpjs' ? 'active':''}}"><a href="#bpjs" data-toggle="tab">BPJS</a></li>
          <li class="{{$active == 'pendidikan' ? 'active':''}}"><a href="#pendidikan" data-toggle="tab">Pendidikan</a></li>
          <li class="{{$active == 'alamat' ? 'active':''}}"><a href="#alamat" data-toggle="tab">Alamat & Kontak</a></li>
          <li class="{{$active == 'npwp' ? 'active':''}}"><a href="#npwp" data-toggle="tab">NPWP</a></li>
          <li class="{{$active == 'kepegawaian' ? 'active':''}}"><a href="#kepegawaian" data-toggle="tab">Kepegawaian</a></li>
        </ul>
          ...
          <div class="tab-pane" id="kependudukan">
            <form class="form-horizontal" method="post" action="/pegawai/biodata/edit/kependudukan">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" required value="{{$data->nik}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Agama</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" required value="{{$data->agama}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Kewarganegaraan</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" required value="{{$data->kewarganegaraan}}">
                  </div>
                </div>
                <div class="form-group">
