...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top"  style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2); background-color:#37517e;">
      <div class="container">
        <div class="navbar-header">
          <a href="/" class="navbar-brand"><b>DINAS LINGKUNGAN HIDUP</b></a>
        </div>
  ...
  <!-- Full Width Column -->
  <div class="content-wrapper"  style="background-image: url('/theme/vektor.jpeg'); background-size:repeat;">
    <div class="container">
            ...
            <div class="box box-warning" style="box-shadow: 2px 18px 18px 18px rgba(0,0,0,.2);border-top-color: #37517e;">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="Nama Lengkap" name="name" value="{{old('name')}}" autocomplete="new-password" />
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="email" class="form-control" placeholder="email" name="email" value="{{old('email')}}" autocomplete="new-password" />
                  </div>
                </div>
                <div class="form-group">
              ...
              <div class="box-footer social-auth-links">
                <button type="submit" class="btn btn-primary btn-block" style="background-color: #37517e;"><i class="fa fa-send"></i> Daftar</button>
                
                <div class="form-group">
                  <div class="col-sm-6 text-left">
                    <a href="#"> <strong> Lupa Password? </strong></a>
                  </div>
                  <div class="col-sm-6 text-right">
                    <a href="/login"> <strong> Sudah Punya Akun? Klik disini </strong></a>
                  </div>
                </div>
