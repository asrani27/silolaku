...
<div class="wrapper">
  ...
  <header class="main-header">
    <nav class="navbar navbar-static-top" style="box-shadow: 0px 4px 30px;background: rgb(2,164,204);
    background: linear-gradient(0deg, rgba(2,164,204,1) 58%, rgba(157,254,255,1) 100%);">
      <div class="container-fluid">
        <div class="navbar-header">
          <a href="#" class="navbar-brand"><b>SILOLAKU</b></a>
